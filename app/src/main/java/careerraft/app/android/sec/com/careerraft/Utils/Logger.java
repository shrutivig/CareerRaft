...
public class Logger {
     ...
     * @return void
     */
    public static void sendLogAsServerLogToCCLogger(Context context, String value) {
        SharedPrefsUtils.setStringPreference(context, String.valueOf(++EVENT_NUMBER), value, Constants.SP_SERVER_NAME);
    }
    ...
    public static Map<String, String> getServerLogFromCCLogger(Context context) {
        return SharedPrefsUtils.dumpSharedPreferenceServerLogs(context);
    }
