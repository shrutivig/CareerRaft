...
import careerraft.app.android.sec.com.careerraft.Constants;
...
public class SharedPrefsUtils {
    ...
    public static Map<String, String> dumpSharedPreferenceServerLogs(Context context) {

        SharedPreferences preferences = context.getSharedPreferences(Constants.SP_SERVER_NAME, Context.MODE_PRIVATE);

        Map<String, String> allEntries = (Map<String, String>) preferences.getAll();
        for (Map.Entry<String, ?> entry : allEntries.entrySet()) {
            Log.d("map values", entry.getKey() + ": " + entry.getValue().toString());
        }

        //     preferences.edit().clear();  //delete shared preference file TODO: CHECK ITS FUNCTIONALITY
        return allEntries;
    }
